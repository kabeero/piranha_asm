...
Diag_S_Edge:
    ...
    ; algorithm.  It must be generic enough to serve both cases, thus variable 
    ; offsets are used.
...
;-------------------------------------------------------------------------------
;
; Second and third levels of the NPP algorithm
;
; At this stage, there are relatively few pixels which have enough in common to
; make looping worthwhile.  This means the second and third levels are primarily 
; hard-coded with the indices.
;-------------------------------------------------------------------------------
